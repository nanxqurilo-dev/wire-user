...
export const mainNavigation: NavigationGroup[] = [
  {
    ...
    groups: [
      { heading: "Barrier systems", items: [
        { label: "Concertina coil", href: "/products/helixguard-concertina-coil" },
        { label: "Razor ribbon", href: "/products/razorline-ribbon-wire" },
        { label: "Flat-wrap barriers", href: "/products/flatguard-flat-wrap-barrier" },
        { label: "Barbed wire", href: "/products/anchorline-barbed-wire" },
      ] },
      { heading: "Fencing & components", items: [
        { label: "Chain-link mesh", href: "/products/gridlock-chain-link-mesh" },
        { label: "Welded mesh panels", href: "/products/panelguard-welded-mesh" },
        { label: "Solar perimeter fencing", href: "/products/pulseguard-solar-fence" },
        { label: "Posts & accessories", href: "/products/vectorpost-y-angle-posts" },
      ] },
    ],
  },
  {
